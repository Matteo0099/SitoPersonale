var Stats = function () {
    ...
    c.style.cssText = "position:fixed;top:0;left:0;cursor:pointer;opacity:0;z-index:10000"; 
...
/* Stats.Panel = function (h, k, l) {
    ...
    return {
        ...
        function (f, v) { 
            ...
            b.drawImage(q, d + a, m, n - a, p, d, m, n - a, p); b.fillRect(d + n - a, m, a, p); b.fillStyle = l; b.globalAlpha = .9; 
