<template>
    <footer class="bottom-0 mx-auto sm:my-2 pt-10 pb-6 max-w-full w-full flex justify-center items-center flex-col">
        <div class="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
            <div class="flex items-center justify-center pl-0 sm:pr-3 sm:justify-start md:pl-1">
                <p class="font-mono text-lg uppercase text-white">Let's connect</p>
            </div>
            <div class="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                ...
                <a href="/" class="pl-4 hover:text-slate-400 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                ...
                <a href="/" class="pl-4 hover:text-slate-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
