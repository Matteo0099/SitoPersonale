        ...
        <div class=" max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden my-4">
            ...
            <div class="py-4 px-6">
                ...
                <p class="py-2 text-lg text-gray-700">
                    I'm 18 y.o., developer, web-designer and sometimes biker.
                </p>
                <div class="flex items-center mt-4 text-gray-700">
                    ...
                    <h1 class="px-2 text-sm">AreaCrew, Isisbem</h1>
                </div>
                <div class="flex items-center mt-4 text-gray-700">
                    <svg class="h-6 w-6 fill-current" viewBox="0 0 512 512">
                        <path
                    ...
                    <h1 class="px-2 text-sm">Italy</h1>
                </div>
                <div class="flex items-center mt-4 text-gray-700">
                    <svg class="h-6 w-6 fill-current" viewBox="0 0 512 512">
                        <path
                    ...
                    <h1 class="px-2 text-sm">matteomania09@gmail.com</h1>
                </div>
            </div>
        </div>
    </section>
